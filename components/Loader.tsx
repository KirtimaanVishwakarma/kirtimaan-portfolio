...
const LINES = [
  ...
  '<span class="arrow">&gt;</span> loading modules [react · nextjs · node · mern] <span class="ok">ok</span>',
  '<span class="arrow">&gt;</span> mounting projects <span class="ok">ok</span>',
        ...
        >
          <div className="loader-box">
            <div className="loader-name">
              kirtimaan<span className="c">.</span>vishwakarma<span className="c">()</span>
            </div>
